    ...
    private fun processRequest(next: String?): ProcessResult {
        ...
        if (isError) {
            ...
            if (next != null && (nextIntValue == null || nextIntValue < 0)) {
                ...
                var fetchedPeople: ArrayList<Person> = ArrayList(people.subList(beginIndex, endIndex)) // begin ile end ayni olunca bos donuyor mu? hayır, index üzerindeki elemanı döner, tek eleman.
